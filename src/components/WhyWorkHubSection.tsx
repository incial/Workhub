...
function StatBlock({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <p className="m-0 text-[32px] font-bold leading-[48px] text-black">
        {display}
      </p>

      <p className="m-0 mt-4 text-sm leading-[21px] text-workhub-muted">
        {label}
      </p>
    </div>
  )
      ...
      <div className="mx-auto max-w-full lg:max-w-[1440px]">
        ...
        <div className="grid gap-16 lg:grid-cols-[534px_1fr] lg:gap-[140px]">
          ...
          >
            ...
            Why Growing Businesses Choose WorkHub
            </SectionLabel>
            ...
            <p className="m-0 text-lg italic leading-[29.25px] text-workhub-secondary">
              WorkHub is built for businesses that need a smarter, simpler way to operate without the complexity of enterprise-grade software.
            </p>
          </motion.div>
            ...
            {BENEFITS.map((benefit, i) => (
              ...
              >
                ...
                >
                  ...
                  <span className="text-base leading-6 text-workhub-benefit">
                    {benefit}
                  </span>
                </motion.div>
              </motion.li>
